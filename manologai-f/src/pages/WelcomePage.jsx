...
const features = [
  {
    title: "Daily Diary",
    description: "A private reflection space for thoughts, experiences, and learning with a built-in streak system.",
    icon: BookOpen,
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  ...
  {
    title: "Habit Tracker",
    description: "Build and maintain behavioral consistency with daily or custom-day tracking and calendar heatmaps.",
    icon: PieChart,
  ...
  },
  {
    ...
    description: "Your personal data scientist. Discover hidden correlations between your habits, sleep, and mood.",
    icon: BrainCircuit,
  ...
  },
  {
    ...
    description: "Keep organized spaces for Goals, Books, To-Do lists, and wild Ideas separate from your journal.",
    icon: ListTodo,
  ...
  {
    title: "Time Tracker",
    description: "Log objective metrics like sleep, screen time, and deep work in under 10 seconds a day.",
    icon: Clock,
    color: "text-rose-400",
    bg: "bg-rose-400/10",
  ...
  {
    title: "Life Rating",
    description: "Measure subjective satisfaction across 8 key life areas like Health, Finances, and Relationships.",
    icon: Star,
  ...
  },
  {
    ...
    description: "A lightning-fast daily mood check-in to identify what triggers your best and worst days.",
    icon: Smile,
    color: "text-pink-400",
    bg: "bg-pink-400/10",
  ...
  },
  {
    ...
    description: "Plan your ideal week using conflict-free time blocks to structure your days perfectly.",
    icon: CalendarDays,
    color: "text-cyan-400",
    bg: "bg-cyan-400/10",
  ...
  },
  {
    ...
    description: "The ultimate command center. All your daily inputs, tasks, and reflections bundled in one view.",
  ...
  return (
    <div className="min-h-screen relative overflow-hidden text-slate-100 flex flex-col">
      ...
      <motion.nav 
        ...
        className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between relative z-10"
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-white">Manolog</span>
        </div>
        <div className="flex items-center gap-4">
          <Button asChild variant="ghost" className="text-sm font-medium text-slate-300 hover:text-white hover:bg-white/10">
            <Link to="/login">Log in</Link>
          </Button>
          <Button asChild className="rounded-full bg-white text-slate-900 hover:bg-slate-200 shadow-sm px-6">
      ...
      <main className="flex-1 flex flex-col pt-20 pb-32 relative z-10">
        ...
        <section className="w-full max-w-5xl mx-auto px-6 text-center space-y-8">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-300 text-xs font-medium uppercase tracking-wider mb-4"
          >
          ...
          >
            Manolog combines journaling, habit tracking, time logging, and AI-powered insights into one beautifully unified daily ritual.
          </motion.p>
          ...
          >
            <Button asChild size="lg" className="h-14 px-8 text-base w-full sm:w-auto rounded-full bg-pink-600 hover:bg-pink-500 text-white font-semibold transition-all shadow-[0_0_40px_-10px_rgba(236,72,153,0.5)] hover:shadow-[0_0_60px_-10px_rgba(236,72,153,0.7)] hover:-translate-y-1">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div 
                  ...
                  whileHover={{ y: -5 }}
                >
                  <Card className={`h-full rounded-2xl ${feature.cardBg} border ${feature.border} hover:bg-white/[0.05] transition-colors relative overflow-hidden group shadow-lg`}>
